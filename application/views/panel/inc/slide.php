<!-- login area start -->
<style media="screen">
  .ptb--100,.login-form-body,.login-form-head,.loginbox{
  ...
  .login-s2{
    max-height: 500px;
background-image: url(<?=$link['panelAssets']?>images/178980968.jpg);
...
<br>
                      ...
                      <div class="form-gp">
                          ...
                          <input autocomplete="new-password" type="password" id="exampleInputPassword1">
                          <i class="ti-lock"></i>
                      </div>
                      ...
                      <div class="submit-btn-area">
                          <button   onclick="loginBtnEvent()"  id="form_submit" type="button">Sign in  <i class="ti-arrow-right"></i></button>
                            <script type="text/javascript">
