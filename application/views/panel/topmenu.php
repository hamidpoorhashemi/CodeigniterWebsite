                                        ...
                                        <div class="nofity-list">
                                            <a href="#" class="notify-item">
                                                <div class="notify-thumb">
                                                    <img src="<?=$link['panelAssets']?>images/author/author-img1.jpg" alt="image">
                                                </div>
                                                <div class="notify-text">
                                                    <p>Aglae Mayer</p>
                                            ...
                                            <a href="#" class="notify-item">
                                                <div class="notify-thumb">
                                                    <img src="<?=$link['panelAssets']?>images/author/author-img2.jpg" alt="image">
                                                </div>
                                                <div class="notify-text">
                                                    <p>Aglae Mayer</p>
                                            ...
                                            <a href="#" class="notify-item">
                                                <div class="notify-thumb">
                                                    <img src="<?=$link['panelAssets']?>images/author/author-img3.jpg" alt="image">
                                                </div>
                                                <div class="notify-text">
                                                    <p>Aglae Mayer</p>
                                            ...
                                            <a href="#" class="notify-item">
                                                <div class="notify-thumb">
                                                    <img src="<?=$link['panelAssets']?>images/author/author-img4.jpg" alt="image">
                                                </div>
                                                <div class="notify-text">
                                                    <p>Aglae Mayer</p>
                            ...
                            <nav>
                                <ul id="nav_menu">
                                  <?php foreach ($menuItem as $key => $value) {?>
                                    <li>
                                        <a href="<?=$link['pageLink']?><?=$value['value']?>"><i class="ti-dashboard"></i><span><?=$value['name']?></span></a>
                                        <?php if(isset($value['submenu']) && count($value['submenu']) > 0){ ?>
                                        <ul class="submenu">
                                              <?php foreach ($value['submenu'] as $key => $value) {?>
                                                      <li><a href="<?=$link['pageLink']?><?=$value['value']?>"><?=$value['name']?></a></li>
                                              <?php   } ?>
                                        </ul>
                                      <?php   } ?>
                                    </li>
